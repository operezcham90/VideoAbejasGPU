...
__kernel void fitness(
	...
	__global float* rand2, // random doubles
	__global float* rand3, // random beta for SBX crossover
	__global float* rand4, // random delta for Polynomial mutation
	...
	__global float* mu_e_obj, // The objective value for each parent explorer bee

	__global float* lambda_e_bees, // The real value components for each offspring explorer bee
	__global float* lambda_e_obj, // The objective value for each offspring explorer bee

	__global float* mu_lambda_bees, // The real value components for each explorer bee
	__global float* mu_lambda_obj, // The objective value for each explorer bee
	...
	__global float* mu_r_obj, // The objective value for each parent foraging bee

	__global float* lambda_r_bees, // The real value components for each offspring foraging bee
	__global float* lambda_r_obj, // The objective value for each offspring foraging bee
